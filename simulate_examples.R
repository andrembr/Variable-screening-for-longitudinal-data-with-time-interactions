...
simulate_LMM <- function(seed=NULL,p,k,ns,tau=1,sigmab,sigmae,setstype,
  ...
  # sigmae: standard deviation of the errors
  # typeset: what are the true active sets of main effects and interactions?
  # randint: is the model a random intercept model with linear effect of time (ex. 1 and 2)? T/F
  # tau: the autocorrelation parameter for the covariates (tau=1 for ex. 1, tau=0.8 for ex. 2)
